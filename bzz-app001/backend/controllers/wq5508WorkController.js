...
const endpoints = methods.crudController("WQ5508Checkmark");
const Util = require("./utilController");
var sql = require("mssql");

const Model = "WQ5508Checkmark";
const calendarModal = "CalendarStaff";
const userModal = "JWT";
const wqModal = "WQ5508";
const progressModel = 'WQ5508Progress'
...
setInterval(() => {
  ...
  // Badge Disappear code  
    ...
    Util.addDataToKPIs('JWT', 'WQ5508', 'WQ1075', 'WQ3177');
    
    Util.checkmark1(Model, 'JWT')

    Util.UpdateCompliance('JWT')

    Util.addWeekDataToKPIs('JWT')
...
endpoints.create = async (req, res) => {
  try {
    ...
    if (recordsets[0].length > 0) {
      ...
      console.log(`update ${Model} set ${valuesQuery} where EMPID = ${values.EMPID}`)
