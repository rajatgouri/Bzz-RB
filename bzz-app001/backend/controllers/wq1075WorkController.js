...
const endpoints = methods.crudController("WQ1075Checkmark");
const Util = require("./utilController");

var sql = require("mssql");

const Model = "WQ1075Checkmark";
const calendarModal = "CalendarStaff";
const userModal = "JWT";
const wqModal = "WQ1075";
const progressModel = 'WQ1075Progress'
...
endpoints.create = async (req, res) => {
  try {
    ...
    let lastDay = (days[days.indexOf(first)+ 4]) //sun - thu or Mon - fri

   
    let workingDays = days.slice(days.indexOf(first), days.indexOf(first)+ 5) // [Mon - Fri]
    ...
    if (recordsets[0].length > 0) {
      ...
      if(currentDay == lastDay) {       // Fri - Fri , Thu - Thu  
