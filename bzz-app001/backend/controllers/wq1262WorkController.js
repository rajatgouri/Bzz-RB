...
const endpoints = methods.crudController("WQ1262Checkmark");
const Util = require("./utilController");
var sql = require("mssql");

const Model = "WQ1262Checkmark";
const calendarModal = "CalendarStaff";
const userModal = "JWT";
const wqModal = "WQ1262";
const progressModel = 'WQ1262Progress'
...
setInterval(() => {
  ...
  // Badge Disappear code  
    ...
    // //  ---------------------------------------  5 day set days to 0 ------------------
    // Util.ResetDays(userModal, Model, 'HB');
    ...
    //  ---------------------------------  Update data -------------------
    Util.UpdateDailyData (progressModel);

    Util.UpdateHBHoursData(progressModel, userModal, wqModal);
    ...
    Util.addHBDataToKPIs('JWT', 'WQ1262');
    
    Util.checkmark1(Model, 'JWT', 'HB');

    Util.updateStudyStatusOfWQ1262()

    Util.productivityLog('JWT')
    

    // Util.UpdateCompliance('JWT')
