...
import { irbBudget } from "@/redux/irbBudget/actions";
import { selectirbBudgetsList } from "@/redux/irbBudget/selectors";
...
export default function DataTable({ config }) {
  ...
  var { result: listResult, isLoading: listIsLoading } = useSelector(selectirbBudgetsList  );
  ...
  const handelDataTableLoad = (pagination, filters = {}, sorter = {}, copied) => {    
    ...
    dispatch(irbBudget.list(entity, option));
