...
export default function DataTable({ config }) {
  ...
  const handelDataTableLoad = (pagination, filters = {}, sorter = {}, copied) => {
    ...
    filteredObject.process = {value: [defaultProcess] , type: "filter"}
  ...
  const loadTable = () => {
    ...
    let filters = {}
      filters['Correct'] = {value: ['No'] , type: 'filter'}
      filters['process'] = {value: [defaultProcess] , type: 'filter'}
      if(defaultProcess == 'PB') {
        filters['Charge Corrected'] = {value: [defaultSubProcess] , type: 'filter'}

      } else if (defaultProcess == 'HB'){ 
        filters['Account Corrected'] = {value: [defaultSubProcess] , type: 'filter'}
            ...
            <Row gutter={[24, 24]} style={{ minHeight: "25px " }}>
              <Col style={{ width: "250px" }}>
                ...
                <Radio.Group style={{marginRight: "2px"}} value={process} >
                    <Radio.Button style={{ marginRight: "5px" }} value="PB" className="box-shadow" onClick={() => onProcessChanged('PB')}>PB</Radio.Button>
                    <Radio.Button  style={{ marginRight: "5px" }} value={"HB"} className="box-shadow" onClick={() => onProcessChanged('HB')}>HB</Radio.Button>
              </Radio.Group>


              | 

              <Radio.Group style={{marginLeft: "10px"}} value={subProcess} onChange={onSubProcessChanged}>
                    <Radio.Button style={{ marginRight: "5px" }} value="Yes" className="box-shadow">Corrected</Radio.Button>
              </Radio.Group>
