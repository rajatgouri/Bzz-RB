    ...
    <div className= {classname}>
          <Row gutter={[24,24]}>
            ...
            <Col span={18}  style={{textAlign :"end"}}>
              <p>
                <Button className="mr-3">Total Search: {extra.Total}  { "    "}</Button>    
                <Button className="mr-3">Match 02149: {extra.IRB} { "    "}</Button>  
                <Button className="mr-3">Medicare Match: {extra.Medicare}  { "    "} </Button> 
                <Button className="mr-3">Double Match: {extra.TargetCriteria}  { "    "}</Button>  
