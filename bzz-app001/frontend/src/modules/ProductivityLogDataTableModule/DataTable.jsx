...
export default function DataTable({ config }) {
  ...
  const handelDataTableLoad = (pagination, filters = {}, sorter = {}, copied) => {    
    ...
    if (!current.managementAccess && !current.adminAccess && !filters.hasOwnProperty('User') && !current.outside) {
      filters.User= [current.name]
    }
    ...
    dispatch(irb.list(entity, option));
