...
export default function Wq1075Logger() {
  ...
  React.useEffect(async () => {
    ...
    const responseFilters = await request.list("wq1075filters");
  ...
  const dataTableTitle = "WQ 1075 Logger" ;
