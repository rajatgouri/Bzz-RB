...
import AllKPIsDataTableModule from "@/modules/AllKPIDataTableModule";
...
export default function AllKPI() {
  ...
  return dataTableColumns.length > 0 && users.length > 0 ? 
     <AllKPIsDataTableModule config={config} />
     : null 
  }  
}
