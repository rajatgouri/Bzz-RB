...
import  WQ3177KPIsChart  from "@/components/WQ3177KPIs";
import WQ3177KPIsTable from '@/modules/WQKPIsDataTableModule'
...
export default function WQ3177KPIs() {
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col className="gutter-row" style={{ width: "100%" }}>
          <div className="whiteBox shadow" style={{ height: "455px" }}>
            <div className="pad20 demo-chart-container" style={{ marginTop: "40px" }} >
              <WQ3177KPIsChart usersList={usersList}> </WQ3177KPIsChart>
            </div>
          </div>
        </Col>
        ...
        <Col className="gutter-row" style={{ width: "100%" }}>
          <div className="whiteBox shadow" style={{ height: "520px" }}>
            <div className="pad20 " >
              <h2 className="font-cinzel">WQ 3177 KPIs</h2>
              <WQ3177KPIsTable config={config}/>
            </div>
          </div>
        </Col>
