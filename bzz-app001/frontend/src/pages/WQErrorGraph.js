    ...
    statistic: {
      title: {
        ...
        customHtml: (container, view, datum) => {
          ...
          const text = datum ? datum.type : 'WQ Error' 
...
export default function WQErrorGraph() {
  ...
  const getData = (options) => {
    dispatch(crud.list('wq5508-error-kpi', options));
  }


  const getData1 = (options) => {
    dispatch(crud1.list('wq1262-error-kpi', options));
  }
              ...
              isLoading && isLoading1 ?
                ...
                <Row gutter={[24, 24]}>
                  <Col span={12}>
                    <Row gutter={[24,24]}>
                      <Col span={24}>
                    <h3 style={{marginBottom: "35px"}}>WQ5508 Errors</h3>
                    ...
                    <div >
                      <div className="inline w-50 font-bold">SA Error </div>
                      <div className="inline w-50 text-end ">{data['KPI'] ? data['KPI']['SA Error'] : 0}</div>
                    </div>
                  ...
                  <Col span={12} >
                    ...
                    <Row gutter={[24,24]}>
                    <Col span={24}>
                    <h3 style={{marginBottom: "35px"}}>WQ1262 Errors</h3>
                    ...
                    <div >
                      <div className="inline w-50 font-bold">SA Error </div>
                      <div className="inline w-50 text-end ">{data1['KPI'] ? data1['KPI']['SA Error'] : 0}</div>
                    </div>
